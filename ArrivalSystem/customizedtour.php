...
<!-- Start Part 3 -->
		...
		<div class="page" style="height: 1200px;">
		<h1>Regions</h1>		
			<!-- tabs -->
							...
							<div class="col-md-12">
								<h1>Available Hotel in Yangon</h1>
                                  ...
                                  <section id="first-tab-group" class="tabgroup">
                                    ...
                                    <div id="tabb5">
                                      <h2>Park Royal</h2>
                                      <img class="rounded" src="images/customizedimages/parkroyal.jpg" alt="Park Royal" style="width:100%; height: 350px;">
                                      		<br>
                                      		<p style="line-height: 30px;color: black;font-family:Ayuthaya;font-size: 15px;margin-left: 20px; text-align: justify;">
