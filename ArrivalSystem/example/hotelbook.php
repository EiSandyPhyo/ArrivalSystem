...
<head>
	<title>Heaven Booking Form a Flat Responsive Widget Template :: w3layouts </title>
	<!-- Meta tags -->
		...
		<form action="#" method="post">
			<div class="mid-cls">
				...
				<div class="hotel-right-w3ls">
					...
					<div class="main">
						<div class="form-left-to-w3l">
<input type="date" name="dateofbirth" id="dateofbirth" placeholder="Arrival-Date" required="">

						</div>
						<div class="form-right-to-w3ls">
<input type="date" name="dateofbirth" id="dateofbirth" placeholder="Departure-Date" required="">
