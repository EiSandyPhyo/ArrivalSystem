...
<div class="super_container">
	...
	<div class="home">
		...
		<div class="home_content">
			<div class="home_title">Our Hotel</div>
		</div>
	</div>
							...
							<div class="row">
								...
								<div class="col-lg-3 col-1680-4">
									<div class="offers_image_container">
										...
										<div class="offers_image_background" style="background-image:url(image/5.jpg)"></div>
										<div class="offer_name"><a href="single_listing.html">Thande Hotel</a></div>
									</div>
								</div>
								<div class="col-lg-8">
									<div class="offers_content">
										...
										<p class="offers_text">
										Yangon Sales & Reservation Office <br>

										 Add: No. 361, Pyi Thar Yar Street, Thingangyun Township, Yangon, Myanmar.

										 Hotline: +959 4298 21304, 7733 61136, 4320 1876, 7754 66625

										 Tel: +951 577 535, 856 4118, 856 1825, 855 0671

										 Email: info.bagan@thandehotel.com sales@thandehotel.com

										Hotel Contact Details

										Hotline: +959 2042189

										 Tel: +95 61 24 60025, 60031, 60964

										 Fax: +95 61 24 60050

										Email: fo.bagan@thandehotel.com 
										Website: www.thandehotel.com
										...
										<div class="button book_button"><a href="hotelbook.php">book<span></span><span></span><span></span></a></div>
							...
							<div class="row">
								...
								<div class="col-lg-3 col-1680-4">
									<div class="offers_image_container">
										...
										<div class="offers_image_background" style="background-image:url(image/2.jpg)"></div>
							...
							<div class="row">
								...
								<div class="col-lg-3 col-1680-4">
									<div class="offers_image_container">
										...
										<div class="offers_image_background" style="background-image:url(image/3.jpg)"></div>
							...
							<div class="row">
								...
								<div class="col-lg-3 col-1680-4">
									<div class="offers_image_container">
										...
										<div class="offers_image_background" style="background-image:url(image/4.jpg)"></div>
										<div class="offer_name"><a href="single_listing.html">eurostar hotel</a></div>
									</div>
								</div>
								<div class="col-lg-8">
