			...
			<div class="home_slider_itemm">
				<div class="home_slider_backgroundd" style="background-image:url(images/about_background.jpg)">
					<div class="home_slider_contentt text-center">
						<h1 id="headerstyle">Flight Information</h1>
					</div>
				</div>
			</div>
		</div>
...
<!-- Start Part 2 -->
	...
	<div class="container">
    	<div class="row">
				...
				<a href="#">
					<img src="images/flight/flightt.png" width="90px" height="90px" class="img-responsive wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">
				</a>
				</div>
				<div class="col-md-5"></div>
			</div>
							...
							<div class="row">
								...
								<div class="col-md-4 col-1680-4">
									<div class="offers_image_container">
										...
										<div class="offer_name"><a href="flightbooking.php">Air KBZ</a></div>
									</div>
								...
								<div class="col-md-7">
									<div class="offers_content">
										...
										<div class="button book_button"><a href="flightbooking.php">book<span></span><span></span><span></span></a></div>
							...
							<div class="row">
								...
								<div class="col-md-4 col-1680-4">
									<div class="offers_image_container">
										...
										<div class="offer_name"><a href="flightbooking.php">Yangon Airways</a></div>
									</div>
								</div>
								<div class="col-md-7">
									<div class="offers_content">
							...
							<div class="row">
								...
								<div class="col-md-4 col-1680-4">
									<div class="offers_image_container">
										...
										<div class="offer_name"><a href="flightbooking.php">Golden</a></div>
									</div>
								</div>
								<div class="col-md-7">
									<div class="offers_content">
							...
							<div class="row">
								...
								<div class="col-md-4 col-1680-4">
									<div class="offers_image_container">
										...
										<div class="offer_name"><a href="flightbooking.php">Mann Yadanarpon</a></div>
									</div>
								</div>
								<div class="col-md-7">
									<div class="offers_content">
							...
							<div class="row">
								...
								<div class="col-md-4 col-1680-4">
									<div class="offers_image_container">
										...
										<div class="offer_name"><a href="flightbooking.php">Air Bagan</a></div>
									</div>
								</div>
								<div class="col-md-7">
									<div class="offers_content">
							...
							<div class="row">
								...
								<div class="col-md-4 col-1680-4">
									<div class="offers_image_container">
										...
										<div class="offer_name"><a href="flightbooking.php">Balloons Over Bagan</a></div>
									</div>
								</div>
								<div class="col-md-7">
									<div class="offers_content">
