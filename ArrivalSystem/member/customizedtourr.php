			...
			<div class="row">
				<div class="col">
					...
					<div class="contact_form_container">
						...
						<div class="row">
							<div class="col-md-4">
								<select class="input-fieldd form-control" name="cregion_id" >
							...
							<div class="col-md-1">
							<button type="submit" name="view" class="form-control"><i class="fa fa-hand-o-right" style="font-size:24px;padding: 2px;"></i></button>
							</div>
							...
							<?php 
                                if(isset($_POST['view']))
                                {
                                    if($_POST['cregion_id']=="----Please Select----")
                                    {
                                        ...
                                        echo "<div data-spy='scroll' data-target='#navbar-example2' data-offset='0' class='scrollspy-example' style='background-color: white; color: black;padding: 10px;'>";
                                        echo "<h4 id='verse1' style='margin-left: 150px;'>Please Choose Hotel in $cregion_name</h4>";
                                        echo "<hr>";
                                        ...
                                        foreach ($db->query($v) as $row)
                                        {
                                            ...
                                            echo "<div class='form-check input_fieldd' style='margin-left: 200px;'>";
                                            echo "<label class='form-check-label'>";
                                            echo "<input type='radio' class='form-check-input' name='radio' value=''>$chotel_name";
                                            echo "</label>"; 
                                            echo "</div>";
                                        }
                                        echo "</div>";
...
{   
    ...
    $insertquery="insert into tbl_customizedbook (cbook_date, cregion_id, chotel_id, ride, duration, person, u_Email) values ('$cbookdate', '$cregion_id','$radio', '$ride', '$duration', '$person', '$u_email')";
    $db -> exec($insertquery);
            					...
            					<div class="row">
            						<div class="container">
            							...
            							<div class="form-check">
                                                    ...
                                                    <input type="radio" class="form-check-input" id="radio1" name="radio" value="ygn">Yangon
                                                 	</label>
                                             	</div>
            							</div>
            							</div>
            							...
            							<div class="form-check">
                                                      ...
                                                      <input type="radio" class="form-check-input" id="radio2" name="radio" value="mdy">Mandalay
                                                      </label>
                                                </div>
            							</div>
            							</div>
            							...
            							<div class="form-check">
                                                      <label class="form-check-label" for="radio3">
                                                       <input type="radio" class="form-check-input" id="radio3" name="radio" value="bgn">Bagan
                                                      </label>
            									</div>
            							</div>
            							</div>
            							...
            							<div class="form-check">
                                                      ...
                                                      <input type="radio" class="form-check-input" id="radio4" name="radio" value="inle">Inle
                                                      </label>
                                                </div>
            							</div>
            							</div>
            							...
            							<div class="form-check">
                                                      <label class="form-check-label" for="radio5">
                                                       <input type="radio" class="form-check-input" id="radio5" name="radio" value="npl">Ngapali
                                                      </label>
            									</div>
            							</div>
            							</div>
