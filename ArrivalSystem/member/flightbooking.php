...
{	?>
							...
							<div class="from">
								<h3 id="ff">From</h3>
								<input type="text" name="fromcity" class="city1" placeholder="Type Departure City" required="">
							</div>
							<div class="to">
								<h3 id="ff">To</h3>
								<input type="text" name="tocity" class="city2" placeholder="Type Destination City" required="">
							</div>
							<div class="clear"></div>
							
								<div class="depart">
									<h3 id="ff">Depart</h3>
									<input  id="datepicker" name="depart" type="text" value="mm/dd/yyyy" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'mm/dd/yyyy';}" required="">
								</div>
								<div class="return">
									<h3 id="ff">Return</h3>
									<input id="datepicker1" name="return" type="text" value="mm/dd/yyyy" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'mm/dd/yyyy';}" required="">
								</div>
							...
							<div class="from">
								<h3 id="ff">Airline</h3>
								<select id="w3_country1" name="airline" required="">
									<option>.....</option>
									<option>Air KBZ</option>  
									<option>Yangon Airways</option>   
									<option>Golden</option>   
									<option>Mann Yadanarpon</option>  
									<option>Air Bagan</option>  
									<option>Balloons Over Bagan</option>  						
								</select>
							</div>
							<div class="to">
								<h3 id="ff">Class</h3>
								<select id="w3_country1" name="class" required="">
									<option>.....</option>
							...
							<div class="clear"></div>
								...
								<select id="w3_country1" name="adult" required="">
											<option>.....</option>
            								<option>1</option>
            								<option>2</option>
            								<option>3</option>
								...
								<div class="to">
									<h3 id="ff">Child(2-11yrs)</h3>
								<select id="w3_country1" name="child" required="">
											<option>.....</option>
											<option>0</option>
            								<option>1</option>
            								<option>2</option>
...
<!-- 							<input type="submit" value="Book Now"> -->
							...
							<div class="col-md-6">
						 	...
						 	<button type="submit" name="roundtripbook" id="form_submit_button" class="form_submit_button button trans_200">BookNow</button>
    						</div>
    						<div class="col-md-3"></div>
    						</div>
...
<!-- 									</span> -->
							...
							<div class="col-md-6">
						 	...
						 	<button type="submit" name="onewaybook" id="form_submit_button" class="form_submit_button button trans_200">BookNow</button>
    						</div>
    						<div class="col-md-3"></div>
    						</div>
						</form>	
				...
				<div class="load_more">	
						<ul id="myList">
							...
							<div class="col-md-6">
						 	...
						 	<button type="submit" name="multicitybook" id="form_submit_button" class="form_submit_button button trans_200">BookNow</button>
    						</div>
    						<div class="col-md-3"></div>
    						</div>
							</form>
...
if(isset($_POST['roundtripbook']))
{
    ...
    $bookdate=date('Y/m/d');
     ...
     $insertquery="insert into tbl_flight_roundtripbooking (book_date, fromm, too, departt, returnn, airline, class, adult, child, u_Email, paymenttype, cardno) values ('$bookdate', '$fromcity','$tocity', '$depart', '$return','$airline', '$class', '$adult', '$child', '$u_email', '$radio', '$cardno')";
     $db -> exec($insertquery);

    $_SESSION['login']=$useremail;
    $_SESSION['book_date']=$bookdate;
    echo ("<script>location.href='roundtripflightbookingprint.php';</script>");
