...
{	?>
						...
						<div class="col-md-12">
						 	...
						 	<button type="submit" name="hotelbooking" id="form_submit_button" class="form_submit_button button trans_200">BookNow</button>
...
//     $total=$night*$r_price;
    ...
    $insertquery="insert into tbl_hotelbooking (book_date, region, hotel, checkin, checkout, night, room, adults, children, u_Email, paymenttype, cardno) values ('$bookdate', '$region','$hotel', '$checkin', '$checkout', '$night', '$room', '$adults', '$children', '$u_email', '$radio', '$cardno')";
    $db -> exec($insertquery);
