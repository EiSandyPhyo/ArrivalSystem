		...
		<div class="room-details-content">
			...
			<br><br>
					...
					<div class="form-group">
    					...
    					<div class="row">
    						<div class="col-md-6">
    							<label class="control-label">Where (Region)</label>
    						</div>
    						<div class="col-md-6">
    							<p id="fonttstylee">
               						<span id="fonttstyleee"><?php echo $region;?></span>
               					</p>
    						</div>
    					</div>
    					</div>
    					...
    					<div class="row">
    						<div class="col-md-6">
    							<label class="control-label">Location (Hotel)</label>
    						</div>
    						<div class="col-md-6">
    							<p id="fonttstylee">
               						<span id="fonttstyleee"><?php echo $hotel;?></span>
               					</p>
    						</div>
    					</div>
    					</div>
    					...
    					<div class="row">
    						...
    						<div class="col-md-6">
    							<p id="fonttstylee">
               						<span id="fonttstyleee"><?php echo $checkin;?></span>
               					</p>
    						</div>
    					</div>
    					</div>
    					...
    					<div class="row">
    						...
    						<div class="col-md-6">
    							<p id="fonttstylee">
               						<span id="fonttstyleee"><?php echo $checkout;?></span>
               					</p>
    						</div>
    					</div>
    					</div>
    					...
    					<div class="row">
    						...
    						<div class="col-md-6">
    							<p id="fonttstylee">
               						<span id="fonttstyleee"><?php echo $night;?></span>
               					</p>
    						</div>
    					</div>
    					</div>
    					...
    					<div class="row">
    						...
    						<div class="col-md-6">
    							<p id="fonttstylee">
               						<span id="fonttstyleee"><?php echo $room;?></span>
               					</p>
    						</div>
    					</div>
    					</div>
    					...
    					<div class="row">
    						...
    						<div class="col-md-6">
    							<p id="fonttstylee">
               						<span id="fonttstyleee"><?php echo $adults;?></span>
               					</p>
    						</div>
    					</div>
    					</div>
    					...
    					<div class="row">
    						...
    						<div class="col-md-6">
    							<p id="fonttstylee">
               						<span id="fonttstyleee"><?php echo $children;?></span>
               					</p>
    						</div>
    					</div>
    					</div>
