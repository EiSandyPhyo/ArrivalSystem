...
<form action="" class="form-horizontal">
		<div class="room-details-content">
				...
				<?php 
				$viewquery="select * from tbl_flight_roundtripbooking where u_Email='$useremail' and book_date='$book_date'";
				$i=1;
			...
			<br><br>
					...
					<div class="form-group">
    					<div class="row">
    						...
    						<div class="col-md-6">
    							<p id="fonttstylee">
               						<span id="fonttstyleee"><?php echo $book_date;?></span>
               					</p>
    						</div>
    					</div>
    					</div>
    					...
    					<div class="row">
    						...
    						<div class="col-md-6">
    							<p id="fonttstylee">
               						<span id="fonttstyleee"><?php echo $fromm;?></span>
               					</p>
    						</div>
    					</div>
    					</div>
    					...
    					<div class="row">
    						...
    						<div class="col-md-6">
    							<p id="fonttstylee">
               						<span id="fonttstyleee"><?php echo $too;?></span>
               					</p>
    						</div>
    					</div>
    					</div>
    					...
    					<div class="row">
    						...
    						<div class="col-md-6">
    							<p id="fonttstylee">
               						<span id="fonttstyleee"><?php echo $departt;?></span>
               					</p>
    						</div>
    					</div>
    					</div>
    					...
    					<div class="row">
    						...
    						<div class="col-md-6">
    							<p id="fonttstylee">
               						<span id="fonttstyleee"><?php echo $returnn;?></span>
               					</p>
    						</div>
    					</div>
    					</div>
    					...
    					<div class="row">
    						...
    						<div class="col-md-6">
    							<p id="fonttstylee">
               						<span id="fonttstyleee"><?php echo $airline;?></span>
               					</p>
    						</div>
    					</div>
    					</div>
    					...
    					<div class="row">
    						...
    						<div class="col-md-6">
    							<p id="fonttstylee">
               						<span id="fonttstyleee"><?php echo $class;?></span>
               					</p>
    						</div>
    					</div>
    					</div>
    					...
    					<div class="row">
    						...
    						<div class="col-md-6">
    							<p id="fonttstylee">
               						<span id="fonttstyleee"><?php echo $adult;?></span>
               					</p>
    						</div>
    					</div>
    					</div>
    					...
    					<div class="row">
    						...
    						<div class="col-md-6">
    							<p id="fonttstylee">
               						<span id="fonttstyleee"><?php echo $child;?></span>
               					</p>
    						</div>
    					</div>
    					</div>
    					...
    					<div class="row">
    						...
    						<div class="col-md-6">
    							<p id="fonttstylee">
               						<span id="fonttstyleee"><?php echo $paymenttype;?></span>
               					</p>
    						</div>
    					</div>
    					</div>
    					...
    					<div class="row">
    						...
    						<div class="col-md-6">
    							<p id="fonttstylee">
               						<span id="fonttstyleee"><?php echo $cardno;?></span>
               					</p>
    						</div>
    					</div>
    					</div>
