...
<div class="container">
    ...
    <?php 
        $search_query = "SELECT pl.package_id,pl.packagelist_id,pl.packagelist_name,pl.packagelist_image,pl.duration,pl.packagelist_price,pl.package_id,pk.package_image FROM packagelist pl LEFT JOIN package pk ON pl.package_id = pk.package_id WHERE pl.packagelist_name LIKE '%$name%' OR pl.packagelist_price = '$name'";
                    
        // echo "<div class='row'>";
        foreach ($db->query($search_query) as $row)
        {
        ...
        <div class="container">
              <div class="card border-light" style="width:400px">
                ...
                <div class="card-body">
                  ...
                  <a href="#" data-toggle="modal" data-target="#exampleModalCenter1" class="btn btn-4" id="fontstylee">Details</a>
