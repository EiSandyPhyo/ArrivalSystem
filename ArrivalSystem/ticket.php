            					...
            					<div class="test_item">
									...
									<div id="test_content_containerr">
										<div class="test_content">
											...
											<div id="test_item_infoo">
												<div class="test_name"><a href="bus.php"><span style="color: black;">Search Cars</span>&nbsp;&nbsp;&nbsp;<img src="images/moredetail.png" width="30px" height="25px" class="img-responsive wow fadeInLeft animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInLeft;"></a></div>
											</div>							
